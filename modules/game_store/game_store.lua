...
function init()
  ...
  ProtocolGame.registerExtendedJSONOpcode(GAME_STORE_CODE, onExtendedOpcode)
...
function terminate()
  ...
  ProtocolGame.unregisterExtendedJSONOpcode(GAME_STORE_CODE)
  destroy()
end

function onExtendedOpcode(protocol, code, json_data)
...
function create()
  ...
  gameStoreButton = modules.client_topmenu.addRightGameToggleButton('gameStoreButton', tr('Store'), '/images/topbuttons/shop2', toggle, false, 8)
